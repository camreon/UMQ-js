...
describe('add to playlist', function() {
    ...
    invalid_tests.forEach(function(test) {
        it(test.type + ' is unsupported & can\'t be added', function(done) {
            app.post('/playlist')
                .send({ url: test.url })
                .expect(400, done);
        });
